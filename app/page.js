        ...
        <div className="mx-auto max-w-6xl px-4">
          <div className="grid gap-10 md:grid-cols-3">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-white/60">akribakes2020@gmail.com</p>
              <div className="mt-4 flex gap-3">
                ...
                <a href="mailto:akribakes2020@gmail.com" className="rounded-full bg-white/10 px-4 py-2 text-xs font-medium text-white transition hover:bg-white/20">Email</a>
              </div>
            </div>
          </div>
        </div>
